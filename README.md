...
`docs/publishing.md` says what stands between this build and a Chrome Web Store
listing; `docs/store-listing.md` holds the listing text, the per-permission
justifications and the privacy answers, and `PRIVACY.md` is the policy itself.
Icons are generated by `tools/make-icons.py`.
